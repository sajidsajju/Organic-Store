...
class userRegister extends Component {
    ...
    onSubmit(e) {
        ...
        axios.post('http://localhost:5000/api/user/register', userReg)
    ...
    render() {
        return (
            <div className="form-bg">
                <h1 className="admin_h1">SIGN-UP</h1>
                ...
                <div className="form-border"><br />
                    ...
                    <form onSubmit={this.onSubmit}><br />
                        ...
                        <input type="submit" value="submit" className="button" /><br /><br /><label>Already a user ? </label><a href="/login" >SIGN IN</a>
                    </form>
                </div>
            </div>
        )
