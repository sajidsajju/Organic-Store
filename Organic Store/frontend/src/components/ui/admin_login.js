...
class adminLogin extends Component {
    ...
    onSubmit(e) {
        ...
        axios.post('http://localhost:5000/api/admin/login', adminLogin)
            .then(res => {
                if (res.data === 201) {
            ...
            <div className="form-bg">
                ...
                <div className="form-border"><br />
                    ...
                    <form onSubmit={this.onSubmit}><br />
                        ...
                        <input type="submit" value="submit" className="button" /><br /><br /><label>Not a user ? </label><a href="/admin-register" >SIGN UP</a>
                    </form>
                </div>
            </div>
        )
